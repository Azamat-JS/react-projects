...
const Footer = () => {
  return (
    <footer className="bg-sky-900 text-white py-8 px-4 mt-10">
      <div className="max-w-5xl mx-auto text-center">
        ...
        <p className="text-sm text-gray-300 mt-6">&copy; {new Date().getFullYear()} Azamat Abdullaev. All rights reserved.</p>
      </div>
    </footer>
  );
};
